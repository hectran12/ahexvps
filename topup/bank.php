...
<body>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <h1 class="page-title fw-semibold fs-18 mb-0">Nạp tiền bank</h1>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Thông tin nạp tiền (Mbbank)</h5>
                                <center>
                                    <img src="https://api.vietqr.io/MBBank/079079123/100000/<?= "AHEXVPS".$userInfo["username"]."NAPTIEN" ?>/vietqr_net_2.jpg?accountName=NGUYEN PHUC NHAN HOA" alt="mbbank" style="width: 300px; height: 300px;">
                                <p class="card-text">Ngân hàng: Mbbank</p>
                                <p class="card-text">Số tài khoản: <?= 
                                $mbbank_number 
                                ?></p>
                                <p class="card-text">Chủ tài khoản: <?= 
                                $mbbank_account_name
                                ?></p>
                                <p class="card-text">Nội dung chuyển tiền: <b><?= "AHEXVPS".$userInfo["username"]."NAPTIEN" ?></b></p>
                                <p class="card-text">Số tiền: <b>tối thiểu <?=
                                number_format($min_payment) ?> VNĐ</b></p>
                    
                                <p class="card-text">Dùng app ngân hàng quét qr để có nội dung chuẩn xác nhất, sau khi bank vui lòng đợi 3-5p để hệ thống cộng tiền. Nếu thấy lâu quá vui lòng inbox cho admin để được hỗ trợ!</p>
                                </center>
    ...
    <script src="../js/update_bank.js"></script>
